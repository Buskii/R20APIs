var TrackerJacker = (function() {
	...
	*/
	...
	var makeRoundDisplay = function(round) {
		...
		content += '<div style="padding: 2px 2px 2px 2px; text-shadow: 1px 1px 2px #000, 0px 0px 1em #FFF, 0px 0px 0.2em #FFF, 1px 1px 1px #FFF; font-style: normal; font-size: 100%; font-weight: bold; color: #FFF; background-color: '+design.roundcolor+'; border: 3px solid #FFF; box-shadow: rgba(0,0,0,0.4) 3px 3px; border-radius: 2em; text-align: center;">'
			+ 'Round ' + round
			+'</div>';
		return content;
	};
	 ...
	 */ 
      var makeTurnDisplay = function(curToken) {
		...
		if (_.find(controllers,function(e){return (e === 'all');})) {
			content += '<tr>'
				+ '<td colspan="0"><div style="font-style: normal; font-weight: bold; font-size: 100%">All Players</div></td>'
				+ '</tr>';
		} else {
			_.each(controllers,function(e) {
				...
				if (player) {
					content += '<tr>'
						+ '<td colspan="3"><div style="font-style: normal; font-weight: bold; font-size: 100%; </div></td>'
					+'</tr>';
				}
			});
		}
